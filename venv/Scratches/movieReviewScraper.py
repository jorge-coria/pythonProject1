...
# Set searchTerm using clipboard content and use it as the search input
searchTerm = pyperclip.paste()
searchInputElem = WebDriverWait(browser, 13).until(
    EC.presence_of_element_located((By.TAG_NAME, 'input'))
)
searchInputElem.send_keys(searchTerm)
